...
class TestAppium(unittest.TestCase):
    ...
    def test_search(self):
        ...
        f.write(f"Amazon homepage load time(Part C): {homepage_load_time:.2f} seconds\n")
        f.write(f"Amazon homepage Effective(excluding Sleep time) load time(Part C): {homepage_load_time-6:.2f} seconds\n")
        f.write("*********************************************************************************\n")

        e.write(f"Activity1: homepage load time(Part C): {homepage_load_time:.2f} seconds\n")
        e.write(f"Activity1: Effective(excluding Sleep time) homepage load time(Part C): {homepage_load_time-6:.2f} seconds\n")
        e.write(f"Activity2: Search Time(Part C): {search_time:.2f} seconds\n")
        e.write(f"Activity2: Effective(excluding Sleep time) Search time(Part C): {search_time-9:.2f} seconds\n")
        e.write(f"Activity3: filter time(Part C): {filter_time:.2f} seconds\n")
        e.write(f"Activity3: Effective(excluding Sleep time) filter time(Part C): {filter_time-10:.2f} seconds\n")
        e.write(f"Activity4: product retrieval time(Part C): {product_time:.2f} seconds\n")
        e.write(f"Activity4: Effective(excluding Sleep time) product retrieval time(Part C): {product_time-2:.2f} seconds\n")
